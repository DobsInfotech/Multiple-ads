      ...
      if (req.body.App == req.params.id) {
        ...
        if (OriginalData.length == 0) {
          let data = new Todo({
            ...
            admob_rewarded_interstitial_id:
              req.body.admob_rewarded_interstitial_id,
            admob_interstitial_dislpay_type:
              req.body.admob_interstitial_dislpay_type,
            admob_native_id: req.body.admob_native_id,
            admob_native_advance_id: req.body.admob_native_advance_id,
            admob_native_advance_video_id:
              req.body.admob_native_advance_video_id,
            ...
            items_between_native_ads: req.body.items_between_native_ads,
          ...
          OriginalData[0].fb_rewarded_display_type =
            req.body.fb_rewarded_display_type;
          OriginalData[0].fb_banner_id = req.body.fb_banner_id;
          OriginalData[0].fb_banner_display_type =
            req.body.fb_banner_display_type;
          OriginalData[0].fb_interstitial_id = req.body.fb_interstitial_id;
          OriginalData[0].fb_interstitial_display_type =
            req.body.fb_interstitial_display_type;
          OriginalData[0].fb_native_id = req.body.fb_native_id;
          OriginalData[0].fb_native_banner_id = req.body.fb_native_banner_id;
          OriginalData[0].fb_native_display_type =
            req.body.fb_native_display_type;
          OriginalData[0].admob_rewarded_display_type =
            req.body.admob_rewarded_display_type;
          ...
          OriginalData[0].admob_interstitial_video_id =
            req.body.admob_interstitial_video_id;
          OriginalData[0].admob_banner_id = req.body.admob_banner_id;
          OriginalData[0].admob_medium_ractangle_id =
            req.body.admob_medium_ractangle_id;
          OriginalData[0].admob_banner_display_type =
            req.body.admob_banner_display_type;
          OriginalData[0].admob_interstitial_id =
            req.body.admob_interstitial_id;
          OriginalData[0].admob_rewarded_interstitial_id =
            req.body.admob_rewarded_interstitial_id;
          OriginalData[0].admob_interstitial_dislpay_type =
            req.body.admob_interstitial_dislpay_type;
          OriginalData[0].admob_native_id = req.body.admob_native_id;
          OriginalData[0].admob_native_advance_id =
            req.body.admob_native_advance_id;
          OriginalData[0].admob_native_advance_video_id =
            req.body.admob_native_advance_video_id;
          OriginalData[0].admob_native_display_type =
